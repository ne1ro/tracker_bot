defmodule TrackerBot.Bot do
  ...
  def send_report(chat_id, name), do: name |> Management.report() |> split_message(chat_id)

  def send_accepted(chat_id), do: split_message(Management.list_accepted(), chat_id)

  def send_message(chat_id, :projects),
    do: Nadia.send_message(chat_id, Management.list_projects())

  def send_message(chat_id, :accepted), do: split_message(Management.list_accepted(), chat_id)

  def send_message(chat_id, :help), do: Nadia.send_message(chat_id, help())

  def send_message(chat_id, :default_project), do: Nadia.send_message(chat_id, @default_project)
